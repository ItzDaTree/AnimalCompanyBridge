...
(function (Il2Cpp) {
   ...
   Il2Cpp.exports = {
    ...
    get classGetName() {
        return r("auztDspoxol", "pointer");
    },
    get classGetNamespace() {
        return r("JTcjUYpFgbi", "pointer");
    },
    ...
    get livenessCalculationBegin() {
        return r("il2cpp_unity_liveness_calculation_begin", "pointer", ["pointer", "int", "pointer", "pointer", "pointer", "pointer", "pointer"]);
    },
    ...
    get methodGetParameters() {
        return r("TsTtqnNKtWo", "pointer", ["pointer", "pointer"]);
    },
    get methodGetParameterType() {
        return r("XarIeeCHIvg", "pointer", ["pointer", "uint32"]);
    },
    get methodGetReturnType() {
        return r("lqPaYYOdUVv", "pointer");
    },
    get methodIsGeneric() {
        return r("paJclrvHrgd", "bool");
    },
    get methodIsInflated() {
        return r("jHsKxcylXua", "bool");
    },
    get methodIsInstance() {
        return r("NEyZenVyNbX", "bool");
    },
    get monitorEnter() {
    ...
    get objectUnbox() {
        return r("sfzgMPzcBft", "pointer");
    },
    get resolveInternalCall() {
        return r("BHROQyEOYRD", "pointer");
    },
    get stringGetChars() {
        return r("AfcEHYhFJrU", "pointer");
    },
    get stringGetLength() {
        return r("CrnZKHAYzWh", "int32");
    },
    get stringNew() {
        return r("yXcEtjrftbG", "pointer");
    },
    get valueTypeBox() {
    ...
    get threadIsVm() {
        return r("PopWfHKqDpW", "bool");
    },
    get typeEquals() {
        return r("CyakgzHPsmz", "bool", ["pointer", "pointer"]);
    },
    get typeGetClass() {
        return r("fC_ugPqDlmt", "pointer");
    },
    get typeGetName() {
        return r("smvSftfLPRw", "pointer");
    },
    get typeGetObject() {
        return r("geiXJUUbhrB", "pointer");
    },
    get typeGetTypeEnum() {
        return r("bEpblKbBdSq", "int");
    }
};
